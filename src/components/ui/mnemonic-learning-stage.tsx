            ...
            <motion.div key={word} variants={quoteVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3, ease: 'easeInOut' }}>
              <div className="space-y-4">
                ...
                <div className="pt-2 flex items-center gap-3">
                  <button disabled className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-border text-muted cursor-not-allowed"><ThumbsUp size={16}/> 有帮助</button>
                  <button disabled className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-border text-muted cursor-not-allowed"><ThumbsDown size={16}/> 无帮助</button>
